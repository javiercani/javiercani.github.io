...
(function($){
    ...
    "use strict";
        ...
        /* Scroll to Main Menu
        ================================================== */
        $('#navigation a[href*=#], h1.logo a').click( function(event) {
            var $this = $(this);
            var offset = -80;
        ...
        $('#cta').click( function(event) {
         ...
         $('.hero-btn').click( function(event) {
            var $this = $(this);
            var offset = 0;
            if($this.attr('href') == '#portfolio' || $('.nomenu').is(':visible')) {
                offset = -80; 
            };
            $.scrollTo( $this.attr('href') , 650, { easing: 'swing' , offset: offset , 'axis':'y' } );
            event.preventDefault();
        ...
        scrollwheel: false,
        zoom: 16,
        center: new google.maps.LatLng(-26.825450, -65.232003), // Tucuman, Argentina
        ...
        var myLatLng = new google.maps.LatLng(-26.826500, -65.232003);
        ...
        $.getJSON( "twitter/get_tweets.php", function( data ) {
            ...
            if(data) {
                ...
                $.each(data, function(){
                    ...
                    tweet += '<span class="time">Twitteado hace ' + this.time_ago + '</span>';
                    tweet += '<span class="one-tweet">' + this.text + '</span>';
                    tweet += '<ul class="tweet-actions">' + 
                                '<li><a target="_blank" href="' + this.actions.reply + '">Retweet</a></li>' + 
                                '<li><a target="_blank" href="' + this.actions.retweet + '">Responder</a></li>' + 
                                '<li><a target="_blank" href="' + this.actions.favorite + '">Favorito</a></li>' + 
                              '</ul>'; 
                    tweet += '</div>';  
